...
export function Header(){
    return (
        <div className="dark:bg-gray-900 animate-moving-line sticky top-0 z-50 bg-white px-56 h-16 grid grid-cols-12 gap-36 shadow-md">
            <div className="dark:text-white dark:bg-black dark:hover:bg-gray-700 text-lg text-center text-gray-600 w-32 mb-2 mt-2 pt-2 duration-700 hover:text-black hover:bg-gray-200 hover:text-2xl active:text-base active:duration-100 rounded-lg">
